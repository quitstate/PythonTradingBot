...
if __name__ == "__main__":
    ...
    # Set the threshold based on the decision scores of the training data
    threshold = detector.set_threshold_from_train_data(  # Higher threshold to detect more obvious anomalies
        percentile=95
    )
